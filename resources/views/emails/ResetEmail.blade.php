...
<center>
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                                    <img align="center" alt="رمز عبورتان را فراموش کرده اید؟"
                                                         class="mcnImage"
 ...
 padding: 0;direction: rtl;'>
                                                        <span style="text-transform:uppercase;direction: rtl;">رمز عبور خود را فراموش کرده اید؟</span>
                                                    </h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;direction: rtl;' valign="top">نگران نباشید! ما به شما اجازه می دهیم که رمز عبور
                                                    جدیدی را تولید
                                                    کنید.
                                                    <br></br>
                                                </td>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                                                <?php
                                                                    $url = "http://127.0.0.1:8000/password/reset/" . $MailToken . '/' . $id;
                                                                ?>

                                                                <a class="mcnButton " href="{{$url}}" style="color: #fff;font-size: 18px;font-weight: bold; text-decoration: none;line-height: 100%;text-align: center;text-decoration: none;"
                                                                   target="_blank" title="Review Lingo kit
                                                                invitation">ریست رمز عبور</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
