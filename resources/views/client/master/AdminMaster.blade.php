                ...
                <ul class="nav navbar-nav pull-right side-menu" style="text-align: right;">
                    ...
                    <li>
                        <a href="{{url('user/main')}}">
                            <i class="fa fa-dashboard fa-fw pull-right"></i>پنل کاربر</a>

                    </li>
                    <li>
                        <a href="{{url('user/profile')}}"><i class="fa fa-user fa-fw pull-right"></i> پروفایل</a>
                    </li>


                    <li class="hidden-md hidden-lg hidden-sm">
                        <a href="{{url('user/showOrders')}}"><i
                                    class="fa fa-first-order fa-fw pull-right"></i>سفارشات</a>
                    </li>
                    ...
                    <li class="hidden-md hidden-lg hidden-sm">
                        <a href="{{url('user/comments')}}"><i class="fa fa-first-order fa-fw pull-right"></i> سفارشات
                            ها</a>
                    </li>
                </ul>
        ...
        <div class="col-lg-2 col-md-3 col-sm-3 sidebar pull-right hidden-xs"
            ...
            <div>
                <ul class="nav side-menu" style="text-align: right;">
                    <li>
                        <a href="{{url('user/main')}}" style="background: #ccc;"><i
